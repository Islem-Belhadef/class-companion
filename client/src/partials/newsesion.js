...
const NewSesion = ({ setShowAddSesion}) => {
  ...
  let sesgroup;
    ...
    const [Newmodule, setNewmodule] = useState(sesmodule)
    ...
    const handleCreate = (e) => {
        ...
        Axios.post("http://localhost:3001/addsesion", {  
            ...
            .then((res) => {
              ...
              navigate("/studentsbygroup",{state:{teacher_id:window.localStorage.getItem("token"), sesiondate: newDate,sesiontime: Time,class_type: Newtype,}})
