    ...
    const handleCreate = (e) => {
        ...
        Axios.post("http://localhost:3001/addsesion", {  
            ...
            .then((res) => {
              ...
              navigate("/studentsbygroup",{state:{teacher_id:window.localStorage.getItem("token"), sesiondate: newDate,sesiontime: Time,class_type: Newtype, class_name: Newmodule,}})
                    ...
                    <div className='select-inputs'>
                        ...
                        <select
                            ...
                            {ModulesList.map((modul)=>(
                                <option 
                                value={`${modul.name} ${modul.speciality}`}>{`${modul.name}`}</option>
                            ))}
